...
import com.example.collegeverse.databinding.PostLayoutBinding
...
class PostRecyclerViewAdapter : RecyclerView.Adapter<PostRecyclerViewAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostRecyclerViewAdapter.ViewHolder {
